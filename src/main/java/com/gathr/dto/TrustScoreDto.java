 ...
 * Trust score calculation: Base 100 + (show_ups * 5) - (no_shows * 10) +
 * (avg_rating * 10) - (reports * 20)
 */
public record TrustScoreDto(
    ...
    public static TrustScoreDto calculate(
            ...
            Double averageRating,
            int reportsAgainst) {
        return calculate(userId, showUps, noShows, averageRating, reportsAgainst, null);
    }
